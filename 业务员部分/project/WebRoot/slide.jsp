    ...
    <div id="wrapper">
        ...
        <div class="slider-wrapper theme-default">
            ...
            <div id="slider" class="nivoSlider">
                ...
                <a href="lendHistory.action"><img src="picture/slider/images/walle.jpg" alt="" title="Lend History"/></a>
                <a href="login.jsp"></><img src="picture/slider/images/nemo.jpg" alt="" title="#htmlcaption" /></a>
            </div>
