...
<div id="form">
	...
	<input class="searchfield" type="text"  name = "device" value="Search..." onfocus="if (this.value == 'Search...') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Search...';}" />
	<input class="searchbutton" type="submit" value="Go" />
	
	
	<!--<tr>
    	<td><input type="text" name="device" style="width: 281px;background:#e2e2e2"/></td>
    </tr>
		<input type="submit" value="提交"  name="submit"  align ="center"/>-->
	</form>
	</fieldset>
