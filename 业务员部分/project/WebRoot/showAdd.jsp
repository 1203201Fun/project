 ...
 <script>
		...
		window.onload = function(){
			...
			for(var i=0; i<total; i++){
				INNER += "<tr class='altrow'><th>Device</th><td align='center'>"+brifeinfo[i][0]+"</td></tr>";
				INNER += "<tr><th>Number</th><td align='center'>"+brifeinfo[i][1]+"</td></tr>";
				INNER += "<tr class='altrow'><th>Location</th><td align='center'>"+brifeinfo[i][2]+"</td></tr>";
				INNER += "<tr><th>Describe</th><td align='center'>"+brifeinfo[i][3]+"</td></tr>";
			}
