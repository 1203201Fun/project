 ...
 <script>
		...
		window.onload = function(){
			...
			for(var i=0; i<total; i++){
				...
				INNER += "<tr class='altrow'><th>型号</th><td align='center'>"+brifeinfo[i][2]+"</td></tr>";
				INNER += "<tr><th>规格</th><td align='center'>"+brifeinfo[i][3]+"</td></tr>";
				INNER += "<tr class='altrow'><th>所属部门</th><td align='center'>"+brifeinfo[i][4]+"</td></tr>";
				INNER += "<tr><th>领用人</th><td align='center'>"+brifeinfo[i][5]+"</td></tr>";
				INNER += "<tr class='altrow'><th>使用目的</th><td align='center'>"+brifeinfo[i][6]+"</td></tr>";
				INNER += "<tr><th>项目编号</th><td align='center'>"+brifeinfo[i][7]+"</td></tr>";
			}
