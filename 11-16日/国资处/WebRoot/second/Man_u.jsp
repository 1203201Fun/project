...
<html>
  ...
  <input style="background:#F9F9F9;border:0px" type="text" name="usertemp">
  ...
  <table id="adm_user" border="2px" cellspacing="0" width="700px">
    ...
    <font face="楷体" size="4px">
    <div style="float:right; padding-bottom:20px; width:45%">
  	<a href="mangerShow.action?order=2" style="text-decoration:none">返回</a>
 	 </div>
  <div style="float:right">用户查询结果</div>
    </font>
    </caption>
