...
<html>
  ...
  <a href="mangerShow.action?order=3" style="text-decoration:none">返回</a>
  </div>
  <div style="float:right">设备查询结果</div>
  </font>
  </caption>
  ...
  <tr align="center" height="40px">
    ...
    <s:iterator value="listnew" status="st">
    <tr align="center" height="40px">
      ...
      <input type="hidden" name="pin_tp" value="${ pin }">
