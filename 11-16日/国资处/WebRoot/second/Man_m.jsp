...
<html>
  ...
  <div style="float:left"><a href="allsearch.action?order=2" style="text-decoration:none; margin-left:100px">设备报修表</a></div>
  </font>
  </div>
  <br>
  <div style="margin-top:20px"></div>
  ...
  <font face="楷体" size="4">
  <a href="mangerShow.action?order=5" style="text-decoration:none">查询返回</a>
  </font>
  </div>
  ...
  <tr align="center" height="40px">
    ...
    <tr align="center" height="40px">
      ...
      <s:form action="add">
      <input type="hidden" name="adddev" value="${ device }">
      ...
      <input type="hidden" name="devname" value="${ device }">
  ...
  <div style="margin-top:20px"></div>
  <table border="2px" id="adm_user" cellspacing="0">
  <caption style="height:30px"><font face="楷体" size="4px">设备报修申请</font></caption>
  ...
  <tr align="center" height="40px">
    ...
    <tr align="center" height="40px">
      ...
      <td width="160px">金额</td>
      <td width="160px" colspan="2">故障描述</td>
      <td width="100px">审批</td>
    </tr>
    
    <tr align="center" height="40px">
      <td width="160px"><s:property value="date"/></td>
      <td width="160px"><s:property value="price"/></td>
      <td width="160px" colspan="2"><s:property value="reason"/></td>
      <td width="160px"> 
      <div style="width:50%; float:left; height:40px">
      <s:form action="Repair">
      <input type="hidden" name="repairdev" value="${ device }">
